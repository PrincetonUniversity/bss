...
if __name__ == '__main__':
    ...
    if False:
        ...
        scores = pymc.geweke(logpost_trace)
        pymc.Matplot.geweke_plot(scores, 'probit')

        pymc.raftery_lewis(logpost_trace, q=0.025, r=0.01)
        
        pymc.Matplot.autocorrelation(logpost_trace, 'probit')
    else:
